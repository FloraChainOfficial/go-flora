...
var (
	MainnetGenesisHash = common.HexToHash("0x35576fce4563afab9fb847c1113642a3ad4b1824d2cd51af6705027149a1d6f8")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		MuirGlacierBlock:    big.NewInt(90_200_000),
		BerlinBlock:         big.NewInt(120_244_000),
		LondonBlock:         big.NewInt(120_965_000),
	...
	MainnetCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0x1771b84b9474cC4ed1AC43F70CE3A1C34B96e958"),
		Signers: []common.Address{
			common.HexToAddress("0x43092EeBDD6e0acCC123E531127DE42EBeFcEcc4"), // 0
		},
		Threshold: 2,
	}
